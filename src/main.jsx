...
const additionalRepos = [
  ...
  { title: 'Risk Analytics Portfolio', repo: 'https://github.com/bennyhin777-ui/risk-analytics-portfolio', tech: 'React · Vite · Portfolio · All four live demos', description: 'The source code for this portfolio site itself — four interactive risk analytics demos, a warm editorial theme, and a downloadable ATS-friendly resume. Built with React and Vite.' },
];
      ...
      <main id="top">
        <section className="hero page-width">
          <div className="hero-copy">
            ...
            <div className="proof-row"><div><strong>4+</strong><span>years in risk & analytics</span></div><div><strong>3</strong><span>high-volume payment environments</span></div><div><strong>6</strong><span>open-source repos on GitHub</span></div></div>
          </div>
